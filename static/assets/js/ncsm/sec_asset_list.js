...
var checkedItems = {};
var showButtonseclist = '';
var dataElement = document.getElementById('deployseclist')
if (dataElement && dataElement.value === 'true') {
    showButtonseclist = true;
} else {
    showButtonseclist = false;
}
var sec_asset_list2 = function () {
    var sec_asset_list2_Data = $('#sec_asset_list2').DataTable({
        ...
        language: {
            "decimal": "",
            "info": showButtonseclist ? "전체 _TOTAL_건 <button class='btn btn-outline-info me-1px' type='button' id='sec_list_all_select'>필터된 자산 그룹 생성</button>" : "전체 _TOTAL_건",
			//"info": "전체 _TOTAL_건 ",
            "infoEmpty": "데이터가 없습니다.",
