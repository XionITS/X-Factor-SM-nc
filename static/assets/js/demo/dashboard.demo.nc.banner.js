...
//          size: 1,
//        },
//        series: [a.server_LChartDataList[0].data[0]],
//        xaxis: {
...
//
//   //--------------------------------------------------------------------------
//    // Total quantity of servers - apexTotalServerChart2 Physical
//    //--------------------------------------------------------------------------
//    var apexTotalServerOptions2 = {
//        chart: {
//          height: 145,
//          type: 'line',
//          toolbar: {
...
//          size: 1,
//        },
//        series: [a.server_LChartDataList[0].data[1]],
//        xaxis: {
//          categories: a.server_LChartDataList[0].date,
//          labels: {
//            show: true,
...
//        }
//    };
//    var apexTotalServerChart2 = new ApexCharts(
//    document.querySelector('#apexTotalServerChart2'),
//    apexTotalServerOptions2
//    );
//    apexTotalServerChart2.render();
//
//
//
//    //--------------------------------------------------------------------------
...
//
    ...
    //--------------------------------------------------------------------------
    // Number of servers by version of OS - hs_asset
    //--------------------------------------------------------------------------
//    var osDonutValue = ['1','2','3']
//    var osDonutName = ['1','2','3']
...
var hs_asset = new ApexCharts(document.querySelector('#hs_asset'),hs_assetChartOptions);
hs_asset.render();


//--------------------------------------------------------------------------
// Number of servers IP list - OS별
//--------------------------------------------------------------------------
//
//group = [];
//value = [];
...
var os_asset = new ApexCharts(document.querySelector('#os_asset'),os_assetChartOptions);
os_asset.render();



    //--------------------------------------------------------------------------
    // Number of servers by version of OS - ip_asset
    //--------------------------------------------------------------------------
//    var osDonutValue = ['1','2','3']
//    var osDonutName = ['1','2','3']
...
var ip_assetChartOptions = {
    ...
    colors: ['#00FFFF',  '#0099FF','#0066FF',  '#0000FF'],
...
var ip_asset = new ApexCharts(document.querySelector('#ip_asset'),ip_assetChartOptions);
ip_asset.render();
