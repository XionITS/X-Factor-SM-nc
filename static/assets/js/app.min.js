...
/*동훈 추가한 드롭다운 활성화 스크립트 */
document.addEventListener('DOMContentLoaded', function () {
    var dropdownToggleElements = document.querySelectorAll('[data-bs-toggle="dropdown"]');
    ...
    function toggleDropdown(event) {
        ...
        if (dropdownMenu.style.display === 'none' || dropdownMenu.style.display === '') {
            ...
            dropdownMenu.style.paddingTop = '10px';
            dropdownMenu.style.paddingBottom = '10px';
        } else {
    ...
    dropdownToggleElements.forEach(function (element) {
        ...
        element.addEventListener('touchstart', toggleDropdown);
    });

    // 페이지의 다른 부분을 클릭하면 드롭다운 메뉴를 닫음
